...
//  Shuba App
//
//  Created by Frimpong Anorchie II on 18/05/2017.
...
class LoginController: UIViewController, UICollectionViewDataSource, UICollectionViewDelegate, UICollectionViewDelegateFlowLayout {
    ...
    let pages: [Page] = {
        let firstPage = Page(title: "Shuba is here to solve our issues", message: "It is capable of helping you keep track of our shuttle systems", imageName: "page1")
        
        let secondPage = Page(title: "Keep track of where they are", message: "Makes you aware of where the buses are in real time", imageName: "page2")
        
        let thirdPage = Page(title: "When will they arrive?", message: "Know when each driver will arrive at a stop and how long it actually takes with their travelling speed", imageName: "page3")
    ...
    lazy var pageControl: UIPageControl = {
        ...
        pc.currentPageIndicatorTintColor = UIColor(red: 0.6275, green: 0, blue: 0.0392, alpha: 1)
    ...
    func nextPage() {
        //we are on the last page of the scroll
    ...
    func saveNotice(userMessage: String) {
        let alertController = UIAlertController(title: "Error message", message: userMessage, preferredStyle: .alert)
        let defaultAction = UIAlertAction(title: "Let Me Try Again", style: .default, handler: nil)
    ...
    func moveToRegisterPage() {
        let registerPage = RegisterController()
