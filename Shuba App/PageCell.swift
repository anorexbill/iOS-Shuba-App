...
class PageCell: UICollectionViewCell {
    ...
    let imageView: UIImageView = {
        ...
        iv.image = UIImage(named: "knust entrance")
    ...
    func setupViews() {
        ...
        lineSeparataorView.anchorToTop(nil, left: leftAnchor, bottom: textView.topAnchor, right: rightAnchor)
        
        lineSeparataorView.heightAnchor.constraint(equalToConstant: 1).isActive = true
    }
